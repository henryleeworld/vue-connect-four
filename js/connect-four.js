    ...
    computed: {
        ...
        message() {
            if (this.isADraw) {
                ...
                return `<b class="${this.currentTurnColor}">${this.currentTurnColor} 贏了！</b>`;
            } else {
                return `<b class="${this.currentTurnColor}">${this.currentTurnColorText}</b>的回合`;
            }
        },
